...
var data = fs.readFileSync('../config/qa/plugins/cordova-bmwlp-passguard/src/android/MainActivity.java', 'utf8');

// replace package name and license??? (passed by args???)
fs.writeFileSync('./platforms/android/src/com/mcongroup/bmw/memberapp/sit/MainActivity.java', data, 'utf8');
