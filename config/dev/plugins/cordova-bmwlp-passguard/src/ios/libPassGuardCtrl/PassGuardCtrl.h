...
@public
    ...
    int  m_defaultSessionKey;
    
    id <instertWebviewTextDelegate> webdelegate;
}
/*!
 *  @brief  加密sessionKey   默认1，可选0
 */
@property (nonatomic) int  m_defaultSessionKey;
 ...
 *  @brief  设置true为反调试模式
 */
@property (nonatomic) BOOL m_isDebug;
/*!
 *    @brief  控制键盘乱序功能：
 ...
 *
 *  @param bmode  true 明文显示，false密文显示
 *
 *  @return 返回控件对象
 */
