...
var data = fs.readFileSync('../config/prod/plugins/cordova-bmwlp-passguard/src/android/MainActivity.java', 'utf8');

// replace package name and license??? (passed by args???)
fs.writeFileSync('./platforms/android/src/com/mcongroup/bmw/memberapp/prod/MainActivity.java', data, 'utf8');
